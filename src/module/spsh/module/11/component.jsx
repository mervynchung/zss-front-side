...
const wspcx = React.createClass({
    ...
    render(){
      ...
      const mxbg=<table className="jgnj">
                ...
                <tr>
                    <td style={{width:'165px'}}><b>年检年度：</b></td>
                    <td>{obj.ND}</td>
                    <td><b>亊务所名称：</b></td>
                ...
                <tr>   
                    <td ><b>年检总结：</b></td>
                    <td className="jgnjnjzj" colSpan="4" ><Input type="textarea"  value={obj.ZJ} disabled autosize /></td>
                </tr>
                 <tr>   
        ...
        return <div className="wspxm-spsh">
            <div className="wrap">
          <SPXX wspcxurl='/spapi/wspcx/jg/11' spmxurl='/spapi/spmxxx/jgnj' mxbg={mxbg} getbg={this.makebg} jgnj
                          columns={C_JG.jg} titleTop="待审事务所年检" titleSecond="事务所年检表明细"
          />
            </div>
        </div>
    }
