...
import {autoformCy,ryjl} from './model.js' 
...
let dy = React.createClass({
	...
	componentDidMount() { 
		const sd=this.props.location.search;
	     req({
	        url: config.HOST+config.URI_API_PROJECT + '/ryxx/cyryxx/'+sd.substring(1,sd.length),
	        method: 'get',
	        type: 'json',
	...
	render(){
		return <div className="cyryjbxx" ><div style={{margin: "auto",top:"0",left:"0",right:"0",width:"1060px",backgroundColor: "#fff",padding:"10px",position: "absolute"}}>
		<CompBaseTable data = {this.state.dataxx}  model ={autoformCy} bordered striped />
