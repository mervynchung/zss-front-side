...
const detail = React.createClass({
    ...
    render(){
        ...
        tz[3] = '纳税调整增加额：${data.tzvalue1}' + <br/> + '纳税调整减少额：${data.tjvalue2}';
        tz[4] = tz[5] = tz[6] = tz[8] = tz[9] = '应补税额：'+data.tzvalue1 + '<br/>' + '应退税额：'+data.tjvalue2;
        tz[10] = '调增应纳税额：${data.tzvalue1}' + <br/> + '调减应纳税额：${data.tjvalue2}';
        ...
        return <Panel title={title} toolbar={panelBar}>
            ...
            <table>
                ...
                <tr>
                    <td>业务类型</td>
                    <td>{data.ywlx}</td>
                    <td colSpan="2">{tz[data.ywlx_dm]}</td>
                </tr>
                <tr>
