...
const c = React.createClass({
    ...
    render(){
        ...
        const listSetting = {
            ...
            helperTitle: '使用帮助',
            //帮助提示的具体内容
            helperDesc: <div><p>本功能显示实际收费金额大于100万，或者小于500元，或者实际收费未填写的业务报备记录</p></div>,
            ...
            //数据来源api
            apiUrl: config.HOST + config.URI_API_PROJECT + '/ywbbsfjeyj',
            //初始搜索条件
            defaultWhere:{}
        };
        ...
        return <div className="ywbbgl sfjeyjgl">
            <div className="wrap">
