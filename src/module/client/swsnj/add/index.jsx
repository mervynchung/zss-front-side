...
let Addswsnj = React.createClass({
    ...
    render() {
        ...
        return <div className="add">
            <Panel title="添加事务所年检表" toolbar={toolbar}>
                <div className="fix-table table-bordered table-striped" >
                    <Form horizontal onSubmit={this.handleSubmit}>
                        ...
                        <Row>
                            ...
                            <Col span="8">
                                <FormItem labelCol={{ span: 9 }} wrapperCol={{ span: 13 }}
                                    label="本年度报备份数："><Input {...getFieldProps('bndbafs', { initialValue: this.state.bndbafs }) }
                                        disabled /></FormItem>
                        ...
                        <Row>
                            <Col span="8">
                                <FormItem labelCol={{ span: 9 }} wrapperCol={{ span: 13 }} label="总人数：">
                                    <Input {...getFieldProps('zrs', { initialValue: obj.dqzrs }) } disabled />
                                </FormItem>
                            </Col>
                            <Col span="8">
                                <FormItem labelCol={{ span: 9 }} wrapperCol={{ span: 13 }}
                                    label="分所数："><Input {...getFieldProps('FSS', { initialValue: obj.dqfss }) }
                                        disabled /></FormItem>
                            </Col>
                        ...
                        <div className="fix-table table-bordered table-striped">
                            ...
                            <Row>
                                <Col span="24">
                                    <FormItem labelCol={{ span: 3 }} wrapperCol={{ span: 21 }} label="年检总结">
                            ...
                            <Row>
                                <Col span="12">
                                    ...
                                    <FormItem labelCol={{ span: 4 }} wrapperCol={{ span: 20 }}
                                        label="事务所负责人意见:"><Input {...fzryjProps } type="textarea" /></FormItem>
                                ...
                                <Col span="6">
                                    <FormItem labelCol={{ span: 6 }} wrapperCol={{ span: 16 }} label="时间:">
                                        <DatePicker {...sjProps} /></FormItem>
                            ...
                            <Row>
                                ...
                                <Col span="3">
                                    <Button type="primary" onClick={this.showModal} loading={this.props.btnloading}> <Icon
                                        type="arrow-up" />提交</Button>
                                </Col>
                                <Col span="3">
                                    <Button type="primary" onClick={this.handleReset} loading={this.props.btnloading}><Icon
