...
import {SelectorYear, SelectorXZ, SelectorNames} from 'component/compSelector'
import './style.css'
                ...
                <Form horizontal onSubmit={this.handleSubmit}>
                    <table>
                        <tbody>
                            <tr>
                                <td>姓名：</td>
                                <td><Select placeholder="选择"/></td>
                                <td>性别：</td>
                                <td><FormItem labelcol="2" wrappercol="20" label="年度"><Input/></FormItem></td>
                                <td rowSpan="6">照片</td>
                            </tr>
                            <tr>
                                <td>出生年月：</td>
