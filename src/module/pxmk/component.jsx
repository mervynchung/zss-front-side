    ...
    handleBGSubmit(value){
        this.setState({bgLoading:true});
            ...
            switch(this.state.view){
                case 1: metd='post';break;
                case 4: metd='put';break;
            }
             req({
                url: API_URL_FB,
                type: 'json',
        ...
        return <div className="zxdpxmk">
            <div className="wrap">
               ...
               {this.state.view==4 &&<Panel title="培训信息修改" toolbar={toolbar2}>
                                    <Spin spinning={this.state.sloading}>
                                    <CompInputBaseTable data={typeof(this.state.letValues.BT)==='undefined'?this.state.dataxx:this.state.letValues}  model={Model.autoformba} bordered striped showConfirm  
